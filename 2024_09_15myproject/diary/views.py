...
class PageCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        return render(request, "diary/page_form.html", {form})
...
class PageDetailView(LoginRequiredMixin, View):
    def get(self, request, id):
        ...
        return render(request, "diary/page_detail.html", {"page": page}) #ここは小文字


class PageUpdateView(LoginRequiredMixin, View):
    def get(self, request, id):
        page = get_object_or_404(Page, id=id)
        form = PageForm(instance=page) #ここは小文字
...
page_updete = PageUpdateView.as_view()
